...
<html>
<head>
<title>Patient-Centered Pharmacy System</title>
...
<h1>Patient-Centered Pharmacy System</h1>
</div>
<div id="main">
  ...
  <section class="container">
	 ...
	 <img src="images/admin.png.jpg">
	  ...
	  <form method="post" action="index.php" align="center" >
        ...
        <p class="submit"><input type="submit" name="submit" value="Login" style = "background: red" ></p>
      </form>
    </div>
    </section>
</div>
<div id="footer" align="Center"style = "background: red" </div>
</div>
