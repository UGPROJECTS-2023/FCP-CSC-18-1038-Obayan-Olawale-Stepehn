...
$titling= <<<EOD
<strong> <font style="font-size:11">Patient-Centered Pharmacy System</font> </strong> <br> <strong>Invoice Receipt</strong><br>
University Health Center,<br> FUD Clinic, NHIS Accredited <br> Tel: +2348069122981 <br> E-mail: fudclinic@gmail.com 
<br>-----------------------------------------
EOD;
$header = array('Drug','Price.',    'Qtty' ,'Cost(Naira.)');
$ddt=<<<EOD
$time   
EOD;
$html = <<<EOD
